  ...
  setup(props) {
    ...
    const initMap = async () => {
      if (!window.kakao || !window.kakao.maps) {
        ...
        // 실제 구현 시에는 아래 주석을 해제하여 스크립트를 동적으로 로드할 수 있습니다
        /*
        ...
        */
        ...
        // 테스트용 맵 대체 UI
        mapContainer.value.innerHTML = '<div class="map-placeholder">카카오맵이 로드되지 않았습니다</div>';
        return;
      }
      ...
      try {
        ...
        mapContainer.value.innerHTML = '<div class="map-placeholder">지도를 불러오는 중 오류가 발생했습니다</div>';
      }
    };
        ...
        const infoContent = `
          <div class="map-info-window">
            ...
            <div class="info-content">
              ...
              <div class="info-time">${formatTime(place.arrivalTime)} - ${formatTime(place.departureTime)}</div>
            </div>
          </div>
        `;
